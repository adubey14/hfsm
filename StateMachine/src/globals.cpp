...
LogStream& STATEMACHINE_UTILS::operator<<( LogStream& stream, const char * r)
{
	return stream << std::string( r);
}

LogStream& STATEMACHINE_UTILS::operator<<( LogStream& stream, const std::string& r)
{
...
LogStream& STATEMACHINE_UTILS::operator<<( LogStream& stream, const int i)
{
	char t[32];
	_snprintf( t, 32,"%i", i);
 ...
 LogStream& STATEMACHINE_UTILS::operator<<( LogStream& stream, const double i)
{
	char t[100];
	_snprintf( t,100, "%f", i);
	return stream << std::string( t);
 ...
 LogStream& STATEMACHINE_UTILS::operator<<( LogStream& stream, const unsigned long l)
 {
	 char t[100];
